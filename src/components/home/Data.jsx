  ...
  return (
    <>
      ...
      >
        ...
        <h3 className="home__subtitle">Website Developer</h3>
        <p className="home__desctription" style={{paddingBottom:"1rem"}}>
        I create clean, modern websites that are responsive and user-friendly. Whether you're looking for a simple landing page, a dynamic website, or an e-commerce solution, I’m here to help bring your ideas to life. <br/>
        <b>Check out my work below!</b>
        </p>
